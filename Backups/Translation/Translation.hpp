...
public:
	enum class Language : ui16
	{
		...
		ENIGMA_ENUM_DECLARE_BEGIN_END(English)
	};
	static String StringifyLanguageEnum(const Language l) noexcept;

public:
	// Gets previous saved language if available, otherwise English as default
...
private:
	...
	inline static std::unordered_set<String> m_english_texts; // < English texts from English.ini as default to help us translate to other languages
};
