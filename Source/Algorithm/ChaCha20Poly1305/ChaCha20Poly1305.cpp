...
void ChaCha20Poly1305::EncryptFile(const String& password, const fs::path& in_filename, const fs::path& out_filename)
{	

}

void ChaCha20Poly1305::DecryptFile(const String& password, const fs::path& in_filename, const fs::path& out_filename)
{
}
