...
private: /* Helper Functions */
	...
	{
#define CASE_RET_STR(c) case iware::cpu::architecture_t::c: return #c
		switch (arch)
		{
			CASE_RET_STR(x64);
			CASE_RET_STR(arm);
...
#undef CASE_RET_STR
	...
	{
#define CASE_RET_STR(c) case iware::cpu::cache_type_t::c: return #c
		switch (cache_type)
		{
...
#undef CASE_RET_STR
	...
	{
#define CASE_RET_STR(c) case iware::cpu::instruction_set_t::c: return #c
		switch (is)
		{
...
#undef CASE_RET_STR
	...
	const char* StringifyKernelVariantEnum(const iware::system::kernel_t variant) const noexcept
	{
		...
		default: return "<unknown kernel variant>";
		}
	}
	...
	const char* StringifyGPUVendorEnum(const iware::gpu::vendor_t vendor) const noexcept
	{
		switch (vendor)
		{
			case iware::gpu::vendor_t::intel: return "Intel";
			case iware::gpu::vendor_t::amd: return "AMD";
			case iware::gpu::vendor_t::nvidia: return "Nvidia";
			case iware::gpu::vendor_t::microsoft: return "Microsoft";
			case iware::gpu::vendor_t::qualcomm: return "Qualcomm";
			case iware::gpu::vendor_t::apple: return "Apple";
			case iware::gpu::vendor_t::unknown: default: return "<unknown gpu vendor>";
		}
	}
