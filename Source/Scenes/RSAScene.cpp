...
void RSAScene::OnImGuiDraw()
{
	...
	ImGui::SetWindowPos(ImVec2(0.0f, 0.0f)); // top left
	{
		// Back button [<] & Title
		{
			...
			const auto title = ENIGMA_TRANSLATE_CSTR("RSA");
...
void RSAScene::OnEncryptButtonPressed()
{
	// Validate fields 
	if (m_text.empty())
	{
...
void RSAScene::OnBackButtonPressed()
{
...
void RSAScene::OnCopyEncryptedBase64TextButtonPressed()
{
